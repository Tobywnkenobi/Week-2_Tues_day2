...
first line - def basic_data_type (input_data):     this line is the input
"""
...
print(basic_data_type("Toby"))
print(basic_data_type(55))
print(basic_data_type(4.6))
print(basic_data_type(False))

# Can also use "return" "else" - like dylan
